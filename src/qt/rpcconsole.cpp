...
{
    QMessageBox msgBox;
    msgBox.setText(tr("This will restart the wallet and download the most recent snapshot availabe, which is more than 1 GB in size.\nYour current blockchain data will be overwritten."));
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Bullion RPC console.") + "<br>" +
