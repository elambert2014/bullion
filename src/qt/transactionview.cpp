                                                    ...
                                                    transactionView(0)
{
    ...
    // typeWidget->addItem(tr("Obfuscated by Fungibility"), TransactionFilterProxy::TYPE(TransactionRecord::Obfuscated));
    // typeWidget->addItem(tr("Fungibility Make Collateral Inputs"), TransactionFilterProxy::TYPE(TransactionRecord::ObfuscationMakeCollaterals));
    // typeWidget->addItem(tr("Fungibility Create Denominations"), TransactionFilterProxy::TYPE(TransactionRecord::ObfuscationCreateDenominations));
    // typeWidget->addItem(tr("Fungibility Denominate"), TransactionFilterProxy::TYPE(TransactionRecord::ObfuscationDenominate));
    // typeWidget->addItem(tr("Fungibility Collateral Payment"), TransactionFilterProxy::TYPE(TransactionRecord::ObfuscationCollateralPayment));
