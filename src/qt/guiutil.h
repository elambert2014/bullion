...
/** Utility functions used by the Vault Qt UI.
 */
namespace GUIUtil
{
...
// Render Bullion addresses in monospace font
...
// Parse "bullion:" URI into recipient object, return true on successful parsing
