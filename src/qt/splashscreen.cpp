...
*/
    ...
    QString titleText = tr("Bullion Vault");
/*    QString versionText = QString(tr("Version %1")).arg(QString::fromStdString(FormatFullVersion()));
    ...
    QString copyrightTextCBX = QChar(0xA9) + QString(" 2013-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Bullion Foundation"));*/
...
/*
    ...
    pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 36, copyrightTextCBX);
