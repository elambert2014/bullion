                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Bullion Vault") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Bullion address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bullion: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Bullion Vault"), this);
    aboutAction->setStatusTip(tr("Show information about Bullion Vault"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Bullion"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Bullion addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Bullion addresses"));
    ...
    openMNConfEditorAction->setVisible(false);  // We don't need this at this time
    ...
    openAction->setStatusTip(tr("Open a bullion: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Bullion Vault help message to get a list with possible Bullion Vault command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Bullion Vault client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Bullion network", "", count));
}
...
{
    QString strTitle = tr("Bullion Vault"); // default title
