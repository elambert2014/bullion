...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    //     return tr("Received via Fungibility");
    ...
    //     return tr("Fungibility Denominate");
    // case TransactionRecord::ObfuscationCollateralPayment:
    //     return tr("Fungibility Collateral Payment");
    // case TransactionRecord::ObfuscationMakeCollaterals:
    //     return tr("Fungibility Make Collateral Inputs");
    // case TransactionRecord::ObfuscationCreateDenominations:
    //     return tr("Fungibility Create Denominations");
    // case TransactionRecord::Obfuscated:
    //     return tr("Obfuscated by Fungibility");
