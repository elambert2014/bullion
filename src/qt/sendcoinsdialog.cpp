                                                    ...
                                                    fFeeMinimized(true)
{
    ...
    // Bullion network does not accept zero fee transactions at this time
    ui->checkBoxFreeTx->setChecked(false/*settings.value("fSendFreeTransactions").toBool()*/);
...
void SendCoinsDialog::coinControlChangeEdited(const QString& text)
{
    if (model && model->getAddressTableModel()) {
        ...
        {
            ui->labelCoinControlChangeLabel->setText(tr("Warning: Invalid CBX address"));
        } else // Valid address
        {
            CPubKey pubkey;
            CKeyID keyid;
