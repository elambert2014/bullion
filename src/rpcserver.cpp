...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Bullion Vault server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Bullion Vault server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"wallet", "getbpnaddress", &getbpnaddress, true, false, true},
        {"wallet", "createmutex", &createmutex, true, false, true},
        {"wallet", "getbpnplace", &getbpnplace, true, false, true},
        {"wallet", "breakbpn", &breakbpn, true, false, true},
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use bulliond, or the -server option to bullion-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> bullion-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:8395/\n";
}
